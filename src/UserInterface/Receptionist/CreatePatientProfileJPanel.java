...
public class CreatePatientProfileJPanel extends javax.swing.JPanel {
    ...
    public CreatePatientProfileJPanel(JPanel upc, Enterprise enterprise, EcoSystem ecoSystem) {
        initComponents();
    ...
    private void initComponents() {
        ...
        add(jButton6, new org.netbeans.lib.awtextra.AbsoluteConstraints(1080, 620, 100, 35));

        jLabel18.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel18.setText("Note:- Click on above button to start chat.");
        add(jLabel18, new org.netbeans.lib.awtextra.AbsoluteConstraints(980, 670, -1, -1));
